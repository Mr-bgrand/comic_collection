...
export function goCollectObservation(record,capture) {
 ...
 if(fmv.status==='no-fmv')return {status:'review-required',reason:'Sales averages are available without an FMV. Review individual matches before recording an estimate.'};
