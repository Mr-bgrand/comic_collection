...
Node ES modules generate static HTML. No framework or component library. Page-specific buttons, cards, tables and dialogs are inline in template modules. The only shared rendering primitive is page({title,css,body,lang}); escapeHtml escapes external records.
