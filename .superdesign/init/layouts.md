...
There is no shared navigation component. Each page authors its own header and navigation. The shared document wrapper supplies the head, viewport and inline styles, with no visible navigation. No layout components need Superdesign extraction for this target.
